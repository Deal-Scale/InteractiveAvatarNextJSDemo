...
export const MCPFunctionSchema = z.object({
	...
	exampleArgs: z.record(z.string(), z.unknown()).optional(),
});
...
export const CreateKanbanTaskSchema = z.object({
	...
	// AI output files (downloadable)
	outputAttachments: z.array(AttachmentSchema).optional(),
