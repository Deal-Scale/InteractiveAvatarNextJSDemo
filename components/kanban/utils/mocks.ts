...
export const mockTasks: KanbanTask[] = [
	{
		...
		// Example AI outputs for DONE task
	},
	{
		id: "task_2",
		...
		outputVideoUrl:
			"https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
		outputImageUrl: "https://place-hold.it/300x500/666/fff",
		outputMarkdown:
			"# AI Result\n\n**Success!** This is example markdown output for the completed AI task.\n\n- Bullet A\n- Bullet B with a [link](https://github.com/TechWithTy/deal-scale-app).",
		outputAttachments: [
			{ filename: "ai-output-summary.md", url: "/static/meeting-notes.md" },
			{ filename: "ai-output-data.csv", url: "/static/lead-list.csv" },
			{ filename: "ai-spec.pdf", url: "/static/requirements.pdf" },
		],
	},
	{
		id: "task_3",
		...
		outputAttachments: [
			...
			{ filename: "ai-output-data.csv", url: "/static/lead-list.csv" },
			{ filename: "ai-spec.pdf", url: "/static/requirements.pdf" },
			{ filename: "ai-output.feature", url: "/static/ai-output.feature" },
		],
	},
	{
		id: "task_ai_1",
