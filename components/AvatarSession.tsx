        ...
        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-zinc-900 to-black">
          <div className="text-center text-zinc-200">
            <div className="mb-3 flex items-center justify-center">
              {viewTab === "brain" && <Brain className="h-8 w-8 text-indigo-400" />}
              {viewTab === "data" && <Database className="h-8 w-8 text-sky-400" />}
              {viewTab === "actions" && <LayoutDashboard className="h-8 w-8 text-emerald-400" />}
            </div>
