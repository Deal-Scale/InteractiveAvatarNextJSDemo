	...
	return (
		<div className={cn("relative", sizeClasses[size], className)}>
			<div className="absolute h-full w-full">
				{/* biome-ignore lint/suspicious/noArrayIndexKey: Static 12 bars for classic spinner; order and length are fixed. */}
				{[...Array(12)].map((_, i) => (
					<div
						key={i}
...
export function DotsLoader({
	...
	return (
		...
		>
			{/* biome-ignore lint/suspicious/noArrayIndexKey: Static 3 dots used for decorative loader; order does not change. */}
			{[...Array(3)].map((_, i) => (
				<div
					key={i}
					className={cn(
...
export function TypingLoader({
	...
	return (
		...
		>
			{/* biome-ignore lint/suspicious/noArrayIndexKey: Static 3 dots used for typing indicator; order does not change. */}
			{[...Array(3)].map((_, i) => (
				<div
					key={i}
					className={cn(
...
export function WaveLoader({
	...
	return (
		...
		>
			{/* biome-ignore lint/suspicious/noArrayIndexKey: Static 5 bars for wave loader; order/length are fixed and non-interactive. */}
			{[...Array(5)].map((_, i) => (
				<div
					key={i}
					className={cn(
...
export function BarsLoader({
	...
	return (
		<div className={cn("flex", containerSizes[size], className)}>
			{/* biome-ignore lint/suspicious/noArrayIndexKey: Static 3 bars for bars loader; order and length are constant. */}
			{[...Array(3)].map((_, i) => (
				<div
					key={i}
					className={cn(
